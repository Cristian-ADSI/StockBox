...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2025 a las 19:13:35
...
(2, 2147483641, 'Ana Gómez', 'Avenida Libertad 456', 'Inactivo'),
(3, 2147483642, 'Luis Rodríguez', 'Calle Mayor 789', 'Activo'),
(4, 2147483643, 'Marta Sánchez', 'Paseo del Sol 321', 'Activo'),
(5, 2147483644, 'Pedro Fernández', 'Calle de la Luna 654', 'Inactivo'),
(6, 2147483645, 'Laura Martínez', 'Avenida de la Paz 987', 'Activo'),
(7, 2147483646, 'José García', 'Calle del Río 135', 'Activo'),
(8, 2147483647, 'Sara López', 'Calle del Mar 246', 'Inactivo'),
(9, 214748368, 'Javier Díaz', 'Avenida Europa 369', 'Activo'),
(10, 1234567891, 'Carla Torres', 'Calle de la Esperanza 456', 'Activo'),
(11, 214748369, 'Raúl Jiménez', 'Calle del Bosque 753', 'Activo'),
(12, 214748361, 'Elena Martínez', 'Calle de las Flores 852', 'Inactivo'),
(13, 214748362, 'Andrés Ruiz', 'Calle del Sol 147', 'Activo'),
(14, 214748363, 'Patricia Pérez', 'Calle del Viento 258', 'Activo'),
(15, 214748364, 'Miguel Alonso', 'Avenida Central 369', 'Inactivo'),
(17, 1040746421, 'Cristian Otero', 'Bello Antioquia', 'Activo');
...
INSERT INTO `detalle_ventas` (`IdDetalleVenta`, `IdVenta`, `NroSerie`, `Producto`, `Cantidad`, `PrecioUnidad`, `Estado`) VALUES
(1, 1, '1', 20, 3, 29.99, 'Efectiva'),
(2, 1, '1', 30, 5, 55, 'Efectiva'),
(3, 2, '2', 10, 10, 79.5, 'Cancelada');
...
(10, 'Escalera de aluminio Werner', 79.5, 55, 'Existente'),
...
(20, 'Linterna LED Streamlight', 29.99, 80, 'Existente'),
...
(30, 'Cerradura de seguridad Yale', 55, 45, 'Existente'),
...
INSERT INTO `ventas` (`Idventa`, `IdCliente`, `IdUsuario`, `NroSerie`, `FechaVenta`, `Monto`, `Estado`) VALUES
(1, 12, 3, 1, '2025-05-06', 364.97, 'Efectiva'),
(2, 14, 3, 2, '2025-05-06', 795, 'Cancelada');
